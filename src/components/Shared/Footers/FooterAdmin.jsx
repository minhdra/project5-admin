    ...
    <>
      <footer className="block py-4">
        <div className="container mx-auto px-4">
          <hr className="mb-4 border-b-1 border-slate-100" />
              ...
              <ul className="flex flex-wrap list-none md:justify-end  justify-center">
                <li>
                  <a
                    ...
                    className="text-slate-500 hover:text-slate-700 text-sm font-semibold block py-1 px-3"
                  >
                    Source by Creative Tim
                  </a>
                </li>
              </ul>
            </div>
